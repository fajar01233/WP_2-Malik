...
<!-- row ux -->
    <div class="row">
        <div class="col-sl-3 col-md-6 mb-4">
            <div class="card border0left-danger shadow h-100 py-2 bg-primary">
                <div class="card-body">
        ...
        <div class="col-x1 col-md-6 mb-4">
        ...
        <div class="col=x1-3 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2 bg-success">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-md font-weight-bold text-white text-uppercase mb-1">Buku Yang Dibo0king</div>
                            <div class="h1 mb-0 font-weight-bold text-white">
                                <?php
                                $where = ['dibooking !=0'];
    ...
    <div class="row">
        <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2">
            <div class="page-header">
                ...
                <i class="fas fa-search mt-2 float-right">Tampilan</i></a>
            </div>
        ...
        <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2">
            <div class="page-header">
                ...
                <a href="<?= base_url('buku'); ?>"><i class="fas fa-search text-primary mt-2 float-right">Tampilan</i></a>
            </div>
